...
COLUMN_MAP: dict[str, str] = {
    ...
    "how many hours do you study per day outside class": "study_hours",
...
VALUE_MAP: dict[str, dict[str, str]] = {
    ...
    "age_range": {
        ...
        "28 and above": "28+", "28+": "28+", "28 and above": "28+",
    },
    "level": {
    ...
    "father_education": {
        ...
        "ond / nce": "OND/NCE", "ond/nce": "OND/NCE", "ond": "OND/NCE", "nce": "OND/NCE",
    ...
    "attendance": {
        "always (90 – 100%)": "Always (90-100%)", "always (90-100%)": "Always (90-100%)",
        "always": "Always (90-100%)",
        "often (70 – 89%)": "Often (70-89%)", "often (70-89%)": "Often (70-89%)",
        "often": "Often (70-89%)",
        "sometimes (50 – 69%)": "Sometimes (50-69%)", "sometimes (50-69%)": "Sometimes (50-69%)",
        "sometimes": "Sometimes (50-69%)",
        "rarely (below 50%)": "Rarely (<50%)", "rarely (<50%)": "Rarely (<50%)",
        "rarely": "Rarely (<50%)",
    },
    "class_prep": {
